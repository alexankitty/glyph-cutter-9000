imageFileHelp='Path to an image with glyphs (fonts) to cut.'
glyphSizeHelp='Size (in px) of each glyph section to cut. If unsure, you\'ll need to check in your image editor and setup a grid until everything is evenly sized.'
kerningSizeHelp='Amount of space (in px) between each glyph.'
outputFileHelp='Where to save the file once done. It can be in any text format.'
...
colorThresholdHelp='How different does the pixel need to be from the background before we can count is as a match'
...
templateFileHelp='Path to a template text file to tell this program how to build the cuts into the output. Not including a template will put the cuts directly into a txt file. Please refer to the readme for more info.'
